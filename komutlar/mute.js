...
exports.run = async(client, message, args) => {
   ...
   let erkek = message.guild.roles.cache.find(r => r.id === '826855834225999934')
   let kayıtsız = message.guild.roles.cache.find(r => r.id === '762566208058556418')
